...
class ScreamDialog extends Component {
  ...
  render() {
    ...
    /* const commentsSelector = useSelector(state=>state.data.scream.comments);
    console.log("[this is comment gotten from using useSelector]", commentsSelector) */
    var dialogMarkup = loading ? (
      ...
      <Grid container spacing={10}>
        ...
        <CommentForm screamId={screamId} history={this.props.history}/>
        <Comments comments={comments} />
      </Grid>
    );

    console.log("[this is loading in screamDialog and dialogMarkUp]",loading, dialogMarkup)
    return (
      <Fragment>
        <MyButton
